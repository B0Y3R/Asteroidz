...
def main():
    ...
    while(True):
        ...
        for asteroid in asteroids:
            player_asteroid_collision = asteroid.check_for_collision(player)


            if player_asteroid_collision:
                print("Game over!")
                sys.exit()

            for bullet in shots:
                bullet_asteroid_collision = asteroid.check_for_collision(bullet)
